...
============================================================
-- Procurement Dashboard — Database Schema + Seed Data
-- Database: aegle_procurement
-- ============================================================

-- Note: Standard SQL database creation varies by platform. 
-- For PostgreSQL/SQL Server/Generic SQL:

-- CREATE DATABASE aegle_procurement;

-- Standard SQL uses schemas or connects directly to the database.
-- For the purpose of this script, we assume context is aegle_procurement.
...
CREATE TABLE orders (
  ...
  CONSTRAINT chk_department CHECK (department IN ('HR', 'Finance', 'Admin')),
